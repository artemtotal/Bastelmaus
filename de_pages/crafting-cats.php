...
<main>
  ...
  <section class="section-header">
    <h1>Katzen, Mäuse, Herzen</h1>
    <p>Kurze Beschreibung des Abschnitts "Katzen, Mäuse, Herzen". Hier können Sie die Arbeiten meines Kindes sehen und Inspiration finden.</p>
  </section>
    ...
    <div class="slider">
      <div class="slides">
        <?php
          ...
          $galleryDir = '../gallery/crafting-cats/';
