...
<main>
  ...
  <section class="section-header">
    <h1>Stempel</h1>
    <p>Kurze Beschreibung des Abschnitts "Stempel". Hier können Sie die Arbeiten meines Kindes sehen und Inspiration finden.</p>
  </section>
    ...
    <div class="slider">
      <div class="slides">
        <?php
          ...
          $galleryDir = '../gallery/crafting-sthampos/';
