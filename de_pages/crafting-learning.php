...
<main>
  ...
  <section class="section-header">
    <h1>Basteln lernen</h1>
    <p>Kurze Beschreibung des Abschnitts "Basteln lernen". Hier können Sie die Arbeiten meines Kindes sehen und Inspiration finden.</p>
  </section>
    ...
    <div class="slider">
      <div class="slides">
        <?php
          ...
          $galleryDir = '../gallery/crafting-learning/';
