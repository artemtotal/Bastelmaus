...
<main>
  ...
  <section class="section-header">
    <h1>Selbst gezeichnet</h1>
    <p>Kurze Beschreibung des Abschnitts "Selbst gezeichnet". Hier können Sie die Arbeiten meines Kindes sehen und Inspiration finden.</p>
  </section>
    ...
    <div class="slider">
      <div class="slides">
        <?php
          ...
          $galleryDir = '../gallery/drawing-self/';
